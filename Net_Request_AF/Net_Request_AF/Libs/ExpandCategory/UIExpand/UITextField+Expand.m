...
+ (instancetype)ex_defaultSearchTextFieldWithFrame:(CGRect)frame
    ...
    searchBtn.backgroundColor = [UIColor ex_whiteFontColor];
    [searchBtn setTitleColor:[UIColor ex_couponStatuFontColor] forState:UIControlStateNormal];
    [textField setRightView:searchBtn];
    [textField setRightViewMode:UITextFieldViewModeAlways];
    [textField ex_setLayerCornerRadius:5.f AndBorderColor:[UIColor ex_lineColor]];
